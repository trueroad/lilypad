...
static BOOL to_utf16_com(LPSTR buff, int size,
			 LPWSTR wbuff, int wsize, int *converted);
static BOOL to_utf16_api(LPSTR buff, int size,
			 LPWSTR wbuff, int wsize, int *converted);
static int detect_codepage(IMultiLanguage2 *mlang, LPSTR buff, int size);
static BOOL convert_codepage(IMultiLanguage2 *mlang,
			     int codepage, LPSTR buff, int size,
			     LPWSTR wbuff, int wsize, int *converted);

BOOL convert_to_utf16(LPSTR buff, int size,
		      LPWSTR wbuff, int wsize, int *converted)
{
